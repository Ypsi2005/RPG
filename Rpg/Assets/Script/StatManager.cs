...
public class StatManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        statStringers[Stats.MaxHP] = (s) => "Hit Points: " + GetValue(Stats.CurrentHP) + "/" + GetValue(Stats.MaxHP);
        statStringers[Stats.CurrentHP] = (s) => "";
        statStringers[Stats.Dodge] = (s) => "Dodge: " + DerivedDodge().ToString("#.#");
        statStringers[Stats.Precision] = (s) => "Precision: " + DerivedPrecision().ToString("#.#");
        statStringers[Stats.ResFire] = (s) => "Fire Resist: " + DerivedResFire().ToString("#.#");
        statStringers[Stats.ResElec] = (s) => "Elec Resist: " + DerivedResElec().ToString("#.#");
        statStringers[Stats.ResCold] = (s) => "Cold Resist: " + DerivedResCold().ToString("#.#");
        statStringers[Stats.Damage] = (s) => "Damage: " + DerivedDamage().ToString("#.#");

        statStringers[Stats.HealthRegen] =
            (s) => "HP Regen: " + GetValueF(Stats.HealthRegen).ToString("#.#") + " pct/sec";
