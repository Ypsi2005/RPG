        ...
        if (inventoryItemList != null) {
            ...
            if (inventoryItemList.itemList.Count > 0) {
                ...
                inventoryItemList.itemList[viewIndex - 1].mag = EditorGUILayout.FloatField("MAG",
                    inventoryItemList.itemList[viewIndex - 1].mag, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].def = EditorGUILayout.FloatField("Def",
                    inventoryItemList.itemList[viewIndex - 1].def, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].mdf = EditorGUILayout.FloatField("MDF",
                    inventoryItemList.itemList[viewIndex - 1].mdf, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].agi = EditorGUILayout.FloatField("AGI",
                    inventoryItemList.itemList[viewIndex - 1].agi, GUILayout.ExpandWidth(false));
                ...
                GUILayout.BeginHorizontal();
                inventoryItemList.itemList[viewIndex - 1].acc = EditorGUILayout.FloatField("ACC",
                    inventoryItemList.itemList[viewIndex - 1].acc, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].cha = EditorGUILayout.FloatField("CHA",
                    inventoryItemList.itemList[viewIndex - 1].cha, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].fokus = EditorGUILayout.FloatField("FOKUS",
                    inventoryItemList.itemList[viewIndex - 1].fokus, GUILayout.ExpandWidth(false));
                ...
                inventoryItemList.itemList[viewIndex - 1].isIndestructible = (bool) EditorGUILayout.Toggle(
                    "Indestructable", inventoryItemList.itemList[viewIndex - 1].isIndestructible,
                    GUILayout.ExpandWidth(false));
